...
<body>
         ...
         <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
            ...
            <div class="button text-center">
               <button class="my-3 "><a href="./insert_product.php" class="nav-link text-light
                 bg-info my-1">Insert Products</a></button><button><a href="index.php?view_products" class="nav-link text-light bg-info my-1">View Products</a>
               </button><button><a href="index.php?insert_category" class="nav-link text-light bg-info my-1">Insert Categories</a>
               </button><button><a href="index.php?view_categories" class="nav-link text-light bg-info my-1">View Categories </a>
               ...
               </button><button><a href="index.php?list_users" class="nav-link text-light bg-info my-1">List Users</a>
               </button><button><a href="index.php?logout" class="nav-link text-light bg-info my-1">Logout</a></button>
            </div>
         </div>
      </div>
      <!-- fourth child -->
   ...
   <!-- bootsrap jss link  -->
   <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha384-Wd2a2tL8LC2vL9eLwGrU7mLsKk5g+eY0Ig2oF+8lq6/8g+J6Kp5oOg0SvF+5J1jp" crossorigin="anonymous"></script>
